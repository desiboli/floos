...
import { Separator } from "@floos/ui/components/separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@floos/ui/components/sheet";
...
import { useIsMobile } from "@floos/ui/hooks/use-mobile";
...
function SidebarMenuButton({
  ...
  const comp = useRender({
    ...
    render: !tooltip ? render : <TooltipTrigger render={render} delay={0} />,
    state: {
